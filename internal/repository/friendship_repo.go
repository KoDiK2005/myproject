...
// Возвращает autoAccepted=true если была встречная pending-заявка и она была принята,
// вместо создания новой pending-записи.
func (r *FriendshipRepo) SendRequest(requesterID, addresseeID int) (bool, error) {
